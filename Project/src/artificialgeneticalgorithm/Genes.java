...
//    public static int SINGLE_BIT_MUTATIONS = 0;
//    public static int SINGLE_SPECIFIC_BIT_MUTATIONS = 0;
//    public static int SINGLE_STRAND_MUTATIONS = 0;
//    public static int SINGLE_SPECIFIC_STRAND_MUTATIONS = 0;
//    public static int SINGLE_BLOCK_MUTATIONS = 0;
//    public static int BREED_FORCE_KEEP = 0;
//    public static int BREED_MAKE_NEW = 0;
//    public static int DIRECT_BREED = 0;
//    public static int MUTATE_BREED_BIT_MUTATIONS = 1;
//    public static int MUTATE_BREED_STRAND_MUTATIONS = 0;
//    public static int MUTATE_BREED_SPECIFIC_BIT_MUTATIONS = 0;
//    public static int MUTATE_BREED_SPECIFIC_STRAND_MUTATIONS = 0;
    ...
    public static final String STRAND_STAT_HEALTH = "11";
    public static final String STRAND_STAT_ATTACK = "10";
    public static final String STRAND_STAT_DEFENSE = "00";
    
    public static final String STRAND_ACTION_ATTACK = "10";
    public static final String STRAND_ACTION_SHIELD_UP = "00";
    public static final String STRAND_ACTION_SHIELD_DOWN = "01";
    
    public static final int NUM_STRANDS_STAT = 10;
    public static final int NUM_STRANDS_ACTION = 5;
    
    /**
     * Strands of genes representing stats.
     */
    private final String[] statStrands;
    /**
     * Strands of genes representing actions.
     */
    private final String[] actionStrands;
    
    public Genes() {
	statStrands = newStatStrands();
	actionStrands = newActionStrands();
    }
    
    public Genes(String[] statStrands, String[] actionStrands) {
	this.statStrands = statStrands;
	this.actionStrands = actionStrands;
    }
